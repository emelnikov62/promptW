...
var GIRL_VOGUE_SKELETON = `КЛЮЧЕВОЕ ТРЕБОВАНИЕ: точно перенести лицо девушки с загруженного фото-референса, это портрет КОНКРЕТНОГО человека, а не собирательный образ. Лицо на результате должно быть таким, чтобы её мгновенно узнали родные. Скопируй лицо 1:1: сохрани без единого изменения форму и ШИРИНУ лица и полноту щёк (НЕ сужай, не утончай, не вытягивай овал — оставь лицо округлым/широким, если оно такое на референсе), овал и линию челюсти, форму и пропорции носа, форму и разрез глаз, расстояние между глазами, брови, форму и полноту губ, скулы, структуру и текстуру кожи, родинки, веснушки — 100% узнаваемость. ЦВЕТ ГЛАЗ — строго как на референсе (светлые глаза НЕ делай тёмными). ВАЖНО: это обычная девушка, а НЕ профессиональная фотомодель — НЕ заменяй её лицо на типовое «модельное», не делай его длиннее, худее, скуластее или симметричнее; сохрани её настоящие, более мягкие и округлые черты, реальную ширину лица и полные щёки. Если её черты отличаются от стандартной модели — это правильно, оставь их ровно как на референсе. БЕЗ сглаживания кожи, БЕЗ AI-эффекта, не идеализируй, не омолаживай, не меняй форму носа и пропорции лица. Чёрно-белая съёмка не должна менять черты лица — это то же самое лицо с референса, просто в монохроме. Если сомневаешься — копируй черты точно с референса. Волосы — цвет и длина строго как на загруженном фото референса; {hair}; волосы НЕ должны закрывать или менять форму лица, оба контура лица видны. Стильный чёрно-белый студийный портрет крупным планом по плечи. {light}. Спокойный уверенный взгляд прямо в камеру. {outfit}. {earrings}. Тёмный однотонный фон. Профессиональная студийная съёмка на среднеформатную камеру, чёткая реалистичная детализация кожи. Глубокий монохром, лёгкое плёночное зерно. Без текста, букв, логотипов и водяных знаков.`;
...
var MAN_SUPERCAR_SKELETON = `КЛЮЧЕВОЕ ТРЕБОВАНИЕ: точно перенести лицо мужчины с загруженного фото-референса, это портрет КОНКРЕТНОГО человека, а не собирательный образ. Лицо на результате должно быть таким, чтобы его мгновенно узнали родные. Скопируй лицо 1:1: сохрани без единого изменения форму и ШИРИНУ лица и полноту щёк (НЕ сужай, не утончай, не вытягивай овал — оставь лицо округлым/широким, если оно такое на референсе), форму и линию челюсти, форму и пропорции носа, форму и разрез глаз, расстояние между глазами, брови, форму губ, скулы, структуру и текстуру кожи, родинки, щетину/бороду и её форму, причёску и линию роста волос — 100% узнаваемость. ЦВЕТ ГЛАЗ — строго как на референсе (светло-голубые глаза НЕ делай тёмными). ВАЖНО: это обычный мужчина, а НЕ профессиональная фотомодель — НЕ заменяй его лицо на типовое «модельное», не делай его худее, скуластее, моложе или симметричнее; сохрани его настоящие черты, реальную ширину лица и комплекцию. БЕЗ сглаживания кожи, БЕЗ AI-эффекта, не идеализируй, не омолаживай, не меняй форму носа и пропорции лица. Если сомневаешься — копируй черты точно с референса. Фотореалистичный кадр в стиле автомобильного люкс-журнала: уверенный мужчина (внешность, причёска, длина и тип волос, наличие или отсутствие бороды и усов, телосложение — строго как на загруженном фото-референсе, ничего не добавлять и не убирать) стоит у спорткара. {odezhda} {ochki} {chasy} Он опирается одной рукой на крыло автомобиля или стоит вполоборота рядом с открытой дверью-ножницами, расслабленная статусная поза, прямой взгляд в камеру, лёгкая полуулыбка. Рядом припаркован {mashina}, лак сияет, на бортах играют блики городских огней и неоновых вывесок. {fon} Кинематографический объёмный свет, тёплые и холодные акценты, неглубокая глубина резкости с лёгким боке от фар и фонарей, эффектные отражения на капоте и асфальте, влажный после дождя асфальт с цветными рефлексами. Атмосфера статуса, скорости и ночного драйва. Естественная кожа с порами и реальной текстурой, реальная растительность на лице или её отсутствие сохранены как на референсе, без ретуши. Вертикальный кадр 9:16. Без текста, букв, логотипов и водяных знаков.`;
...
var MAN_BOSS_SKELETON = `КЛЮЧЕВОЕ ТРЕБОВАНИЕ: точно перенести лицо мужчины с загруженного фото-референса, это портрет КОНКРЕТНОГО человека, а не собирательный образ. Лицо на результате должно быть таким, чтобы его мгновенно узнали родные. Скопируй лицо 1:1: сохрани без единого изменения форму и ШИРИНУ лица и полноту щёк (НЕ сужай, не утончай, не вытягивай овал — оставь лицо округлым/широким, если оно такое на референсе), форму и линию челюсти, форму и пропорции носа, форму и разрез глаз, расстояние между глазами, брови, форму губ, скулы, структуру и текстуру кожи, родинки, щетину/бороду и её форму, причёску и линию роста волос — 100% узнаваемость. ЦВЕТ ГЛАЗ — строго как на референсе (светло-голубые глаза НЕ делай тёмными). ВАЖНО: это обычный мужчина, а НЕ профессиональная фотомодель — НЕ заменяй его лицо на типовое «модельное», не делай его худее, скуластее, моложе или симметричнее; сохрани его настоящие черты, реальную ширину лица и комплекцию. БЕЗ сглаживания кожи, БЕЗ AI-эффекта, не идеализируй, не омолаживай, не меняй форму носа и пропорции лица. Если сомневаешься — копируй черты точно с референса. Фотореалистичный студийный editorial-портрет «Босс»: уверенный мужчина (внешность, причёска, длина и тип волос, наличие или отсутствие бороды и усов, телосложение — строго как на загруженном фото-референсе, ничего не добавлять и не убирать) снят по грудь на однотонном тёмном студийном фоне. Он одет в {clothing}. Поза статусная и собранная: корпус слегка развёрнут, плечи расправлены, взгляд прямой в камеру, спокойная уверенность сильного руководителя. Студийный свет: {light}. Борода: {beard}. {accessory} Глубокий монохром: насыщенный чёрно-белый кадр с богатой тональной градацией, контрастными тенями и мягким зерном плёнки, тёмный фон уходит в чёрный, акцент на лице и глазах. Естественная текстура кожи и реальная растительность на лице или её отсутствие сохранены как на референсе, без сглаживания. Снято на полнокадровую камеру с портретным объективом 85 мм, малая глубина резкости, резкий фокус на глазах. Вертикальный кадр 9:16. Без текста, букв, логотипов и водяных знаков.`;
...
var MAN_BOSS_PARAMS = [
    ...
    { id:"beard", control:"sheet", label:{ru:"Борода",en:"Beard",es:"Barba"},
      options:[
        {value:"as-reference", label:{ru:"Как на референсе",en:"As in reference",es:"Como en la referencia"}, frag:"растительность на лице точно как на референсе: если есть борода или щетина — сохрани её форму и длину; если лицо гладко выбрито — оставь гладко выбритым, бороду не добавляй"},
        {value:"neater", label:{ru:"Аккуратнее",en:"Neater",es:"Más cuidada"}, frag:"та же растительность на лице, что на референсе, но чуть аккуратнее по контуру (если борода есть); если лицо выбрито — оставь выбритым; черты лица не менять"},
...
var MAN_GANGSTER_SKELETON = `КЛЮЧЕВОЕ ТРЕБОВАНИЕ: точно перенести лицо мужчины с загруженного фото-референса, это портрет КОНКРЕТНОГО человека, а не собирательный образ. Лицо на результате должно быть таким, чтобы его мгновенно узнали родные. Скопируй лицо 1:1: сохрани без единого изменения форму и ШИРИНУ лица и полноту щёк (НЕ сужай, не утончай, не вытягивай овал — оставь лицо округлым/широким, если оно такое на референсе), форму и линию челюсти, форму и пропорции носа, форму и разрез глаз, расстояние между глазами, брови, форму губ, скулы, структуру и текстуру кожи, родинки, щетину/бороду и её форму, причёску и линию роста волос — 100% узнаваемость. ЦВЕТ ГЛАЗ — строго как на референсе (светло-голубые глаза НЕ делай тёмными). ВАЖНО: это обычный мужчина, а НЕ профессиональная фотомодель — НЕ заменяй его лицо на типовое «модельное», не делай его худее, скуластее, моложе или симметричнее; сохрани его настоящие черты, реальную ширину лица и комплекцию. БЕЗ сглаживания кожи, БЕЗ AI-эффекта, не идеализируй, не омолаживай, не меняй форму носа и пропорции лица. Если сомневаешься — копируй черты точно с референса. Фотореалистичный кинематографичный портрет в стиле «Острые козырьки», Бирмингем 1920-х годов. Мужчина (внешность, причёска, длина и тип волос, наличие или отсутствие бороды и усов, телосложение — строго как на загруженном фото-референсе, ничего не добавлять и не убирать) уверенно смотрит в кадр, поза статусная и собранная, плечи развёрнуты. На нём {suit}. На голове {headwear}. {accessory}. Действие происходит в обстановке: {background}. Тёплый приглушённый кинематографический свет, мягкие тёплые блики и глубокие тени, лёгкая дымка в воздухе, атмосфера эпохи, винтажная цветокоррекция с тёплыми янтарными и серо-коричневыми тонами, неглубокая глубина резкости с мягко размытым фоном. Детализированная фактура твида и ткани, реалистичная кожа без сглаживания, реальная растительность на лице или её отсутствие сохранены как на референсе. Вертикальный кадр 9:16. Без текста, букв, логотипов и водяных знаков.`;
