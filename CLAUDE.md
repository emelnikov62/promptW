...
- **writing-plans** — после brainstorming (его штатный следующий шаг) ИЛИ когда уже есть
  спека/требования: разбить многошаговую реализацию на детальный упорядоченный план ДО
  кода. Применять на нетривиальных задачах — новые фичи, миграции, многофайловые правки.
